...
class ExtractMessage extends StatefulWidget {
  final filteredNumbers;
  const ExtractMessage({super.key, required this.filteredNumbers});

  @override
  State<ExtractMessage> createState() => _ExtractMessageState();
}

class _ExtractMessageState extends State<ExtractMessage> {
  ...
  void initState() {
    super.initState();
    _loadSavedBalance();
    recipientsController.text = widget.filteredNumbers.join(' ');
  }
